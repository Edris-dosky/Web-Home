...
<hr class="container mx-auto my-4 border-b-1 border-blueGray-300">
    <form action="<?php echo $db->secure($_SERVER['PHP_SELF']);?>" method="POST"  class="flex flex-row-reverse flex-wrap container mx-auto">
        ...
        <div class="w-6/12 lg:w-2/12 px-4">
          ...
          <div class="w-6/12 lg:w-2/12 px-4">
            <button  type="submit" onclick="search()" class="w-full p-1 rounded-md bg-[#188F8D] hover:bg-[#106564] text-white text-center  text-xl ">
            <svg aria-hidden="true" class=" inline mr-4 w-6 h-6 text-orange-500 " fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
            گەران
          </button>
            </div>
