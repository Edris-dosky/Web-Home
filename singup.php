...
<div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 bg-[#188F8D] py-10 px-10">
            ...
            <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ;?>" method="POST" class="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-900 pb-2">دروستکردنی هەژمار</h1>
                    <p>تکایە خانەکانی خوارەوە بە جوانی پربکەوە </p>
                </div>
                <div>
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5 relative">
